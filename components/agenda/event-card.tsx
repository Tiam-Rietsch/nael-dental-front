...
export const EventCard = ({
  ...
  const { appointmentDetailsDialog, reprogramAppointmentDialog } =
    useAcceuilDialogs();
          ...
          >
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  className="absolute z-100 right-0 bottom-0 p-0 h-fit text-black"
                  variant="ghost"
                  size="sm"
                >
              ...
              <DropdownMenuContent className=" bg-white text-foreground p-2">
                ...
                <DropdownMenuGroup>
                  ...
                  >
                    Ajouter en salle d'attente
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onClick={(e) => {
                      e.stopPropagation();
                      reprogramAppointmentDialog.openDialog();
                    }}
                  >
                    Reprogrammer le RDV
                  </DropdownMenuItem>
