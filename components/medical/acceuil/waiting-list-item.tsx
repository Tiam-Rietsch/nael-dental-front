...
export default function WaitingListItem({ waitingPatient }: WaitingListItemProps) {
  return (
    <div className="border-l-4 border-l-primary bg-white w-full h-[220px] rounded-lg flex flex-col border border-gray-200 transition-all duration-300 hover:shadow-lg hover:shadow-gray-200/50 hover:-translate-y-1 cursor-pointer group">
      ...
      <div className="w-full flex-1 border-b border-gray-100 p-3 flex flex-row gap-4">
        <div className="flex-shrink-0">
          <Avatar className="w-12 h-12 rounded-lg">
            ...
            />
            <AvatarFallback className="bg-blue-100 text-blue-600 font-medium rounded-lg">
              {waitingPatient.patient.nom.charAt(0)}
              {waitingPatient.patient.prenom.charAt(0)}
            </AvatarFallback>
          </Avatar>
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between mb-2">
            ...
            <Badge
              variant="secondary"
              className="bg-yellow-100 text-yellow-700 hover:bg-yellow-100 text-xs font-medium"
            >
              En attente
            </Badge>
          </div>
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-gray-700">Non présent</span>
      ...
      <div className="w-full grid grid-cols-3 divide-x divide-gray-100">
        <div className="px-2 py-2 text-center">
          <div className="text-xs font-medium text-gray-500 mb-1">État financier</div>
          <div className="text-xs font-semibold text-green-600">GOOD</div>
        </div>
        <div className="px-2 py-2 text-center">
          <div className="text-xs font-medium text-gray-500 mb-1">État du rendez-vous</div>
          <div className="text-xs font-semibold text-red-600">X</div>
        </div>
        <div className="px-2 py-2 text-center">
          <div className="text-xs font-medium text-gray-500 mb-1">Assurance</div>
          <div className="text-xs font-semibold text-gray-900">COMPLETE</div>
        </div>
      </div>
    </div>
  )
